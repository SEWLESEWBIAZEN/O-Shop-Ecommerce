  ...
  return (
    <div className=' border-b border-gray-300'>
        ...
        <div className='hidden md:flex md:flex-row gap-2 '>
            <div className='social-media-link bg-gray-400 p-1 rounded rounded-md'><FaFacebook/></div>
            <div className='social-media-link bg-gray-400 p-1 rounded rounded-md'><FaTwitter/></div>
            <div className='social-media-link bg-gray-400 p-1 rounded rounded-md'><FaInstagram/></div>
            <div className='social-media-link bg-gray-400 p-1 rounded rounded-md'><FaLinkedin/></div>
        </div>
