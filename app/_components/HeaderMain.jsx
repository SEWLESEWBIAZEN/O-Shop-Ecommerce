      ...
      <div className='container flex flex-row justify-between items-center' >
        ...
        <div className='hidden sm:flex  gap-3 '>
          ...
          <div className='flex flex-col items-center -space-y-11 '>
            ...
            <div className='px-[6px] rounded rounded-full z-40 grid place-items-center bg-[var(--primary-color)] text-white rounded rounded-[4px] text-[#f45f3f] text-bold'><b>4</b></div>
          </div>
          <div className='flex flex-col items-center -space-y-11 '>
